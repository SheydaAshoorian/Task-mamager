...
async login(dto: LoginDto) {
    ...
    const test1 = await bcrypt.compare(manualHash,  user.password);
  ...
  const isMatch = await bcrypt.compare(dto.password, '$2b$10$qwOMVtvbBmB1JEgxkK.MAuOFS7mVTDtEMrBIdKA2Kg5dpHfRYpyQO');
